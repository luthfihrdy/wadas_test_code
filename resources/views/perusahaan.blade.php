...
@section('content')
        ...
        <div class="container">
            ...
            <table class="table">
                <thead class="thead-dark">
                  <tr>
                    <th style="display: none; visibility: hidden;">ID Perusahaan</th>
                    <th scope="col">#</th>
                ...
                <tbody>
                    ...
                    <tr class="data-rows">
                        ...
                        <th scope="row">{{$i}}</th>
                        <td class="name">{{$data->nama_perusahaan}}</td>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Awal Form -->
                <form action="{{route('perusahaan_submit')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                      <label>Alamat</label>
                      <textarea class="form-control" name="alamat" rows="3" placeholder="Masukkan Alamat Perusahaan"></textarea>
                    </div>
    ...
    <div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action="{{route('perusahaan_update')}}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="modal-input-name" name="nama_perusahaan">
                </div>
                <div class="form-group">
                    <label for="nama" class="col-form-label">Alamat</label>
                    <textarea class="form-control" id="modal-input-alamat" name="alamat" rows="3"></textarea>
                </div>
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('perusahaan_delete')}}" method="POST">
